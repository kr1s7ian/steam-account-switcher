...
def Steamlogin(username):
    os.system(F'reg add "HKCU\Software\Valve\Steam" /v AutoLoginUser /t REG_SZ /d '+username+' /f')
    os.system(F'reg add "HKCU\Software\Valve\Steam" /v RememberPassword /t REG_DWORD /d 1 /f')
...
label=ck.CTkLabel(master=frame,text="Steam Account Switcher",font=("Arialbd",40))
